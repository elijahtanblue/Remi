...
export const MODELS = {
  STAGE1_EXTRACT: 'gemini-2.5-flash-lite',   // Gemini: high-volume per-message extraction (paid tier)
  STAGE2_SNAPSHOT: 'gpt-5.4-nano',           // OpenAI: snapshot synthesis + /brief
  STAGE3_PROPOSE: 'gpt-5.4',                 // OpenAI: writeback proposal generation
  STAGE4_CWR: 'gpt-5.4-nano',                // OpenAI: CWR synthesis from snapshots + Jira
} as const;
